                    ...
                    <div className="flex items-center gap-2 mt-2 xl5:flex-col xl5:items-start">
                      <div className="flex -space-x-4 rtl:space-x-reverse">
                        ...
                        {project.team.length > 3 && (
                          <Link
                            class="flex items-center justify-center w-10 h-10 text-xs font-medium text-gray-400 hover:text-white bg-gray-300 rounded-full hover:bg-gray-400 dark:border-gray-800 transition-all duration-200"
                            href="#"
                          >
                            +{project.team.length - 3}
                          </Link>
